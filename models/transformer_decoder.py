...
class TransformerDecoderLayer(nn.Module):
    ...
    def with_pos_embed(self, tensor, pos: Optional[Tensor]):
        # print("tensor:", tensor.shape, "pos: ", pos)
        if pos is None:
            return tensor
        else:
            return tensor + pos
    ...
    def forward_post(self, tgt, memory,
        ...
        #print("tgt in layer:", tgt.shape, "ws in layer:", ws.shape)
    ...
    def forward_pre(self, tgt, memory,
        ...
        #     print("forward_post->", "tgt2:", tgt2.shape, "query_pos:", query_pos.shape)
        # else:
        #     print("forward_post->", "tgt2:", tgt2.shape, "query_pos:", query_pos)
        ...
        tgt2,attn_weights = self.multihead_attn(query=self.with_pos_embed(tgt2, query_pos),
                                   ...
                                   value=memory, attn_mask=memory_mask,
                                   key_padding_mask=memory_key_padding_mask)
        #print("tgt2:", tgt2.shape, "attn_weights:", attn_weights.shape)

        tgt = tgt + self.dropout2(tgt2)
        tgt2 = self.norm3(tgt)
        tgt2 = self.linear2(self.dropout(self.activation(self.linear1(tgt2))))
        tgt = tgt + self.dropout3(tgt2)
        #print("tgt: ", tgt.shape, "attn_weights:", attn_weights.shape)
    ...
    def forward(self, tgt, memory,
        ...
        if self.normalize_before:
            #print("normaliza_before:", self.normalize_before)
